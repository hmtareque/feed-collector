    ...
    <div class="row">
        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <select name="action" class="form-control">
                                        ...
                                        <option value="unmark" @if(old('action') == 'unmark') selected @endif>Unmark Actioned</option>
            ...
            <div class="alert alert-warning" role="alert">
                <strong>Warning!</strong> No article found to marked actioned! 
                <a href="{{url('articles/not-actioned')}}" class="alert-link">please goto not actioned articles to mark actioned</a>.
            </div>
            @endif 
        </div>
    </div>
